...
;; TODO: nix-get should return an async promise, and the function
;; generated by nix-require should await it. If called interactively
;; it could instead just return nothing and call a function to display
;; the derivation path on completion.
